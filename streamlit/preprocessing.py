...
def preprocess(df, option):
    cols = ['Country_extremely_high_90k_198k',
        ...
        'CompanySize_10000ormoreemployees',
        'Age_18_24_years_old',
        ...
        'CompanySize_Fewerthan10employees',
        ...
        'CompanySize_1000to4999employees',
        'CompanySize_2465.2956061008513',
        ...
        'JobContactPriorities4_Bad',
        'CompanySize_20to99employees',
        'JobContactPriorities1_Good',
        'DatabaseWorkedWith_MariaDB',
        'FrameworkWorkedWith_React',
        'AdsActions_Saw_an_online_advertisement_and_then_researched_it__without_clicking_on_the_ad_',
        ...
        'DatabaseDesireNextYear_SQL_Server',
        ...
        'IDE_Visual_Studio_Code',
        'AssessBenefits2_Good',
        'PlatformDesireNextYear_Raspberry_Pi',
        'NumberMonitors_1',
        'DatabaseWorkedWith_Amazon_DynamoDB',
        'IDE_Android_Studio',
        ...
        'AdsActions_Clicked_on_an_online_advertisement',
        'PlatformDesireNextYear_Serverless',
        'PlatformDesireNextYear_AWS',
        'LanguageDesireNextYear_PHP',
        'AssessJob7_Bad',
        'CommunicationTools_Other_wiki_tool__Github_Google_Sites_proprietary_software__',
        'AdsPriorities7_Bad',
        'JobContactPriorities2_Good',
        'DevType_Product_manager',
        'ErgonomicDevices_Standingdesk',
        'DatabaseWorkedWith_MySQL',
        'HackathonReasons_To_improve_my_knowledge_of_a_specific_programming_language_framework_or_other_technology']
